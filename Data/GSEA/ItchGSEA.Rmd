...
write.table(e13_DRG |> dplyr::filter(AdjP <= 0.01) |> dplyr::select(GeneID) |> unlist() |> as.character(), 'C:/Users/Erik/Desktop/Programming/R/Bio/Itch/e13_DEGs.csv', row.names = F, col.names = F, sep = ',')
...
p0_DRG <- read.csv("C:/Users/Erik/Downloads/DESeq2_result_file_on_GT_p0_mu234_wtBCD_PARA.csv", header = T)

write.table(p0_DRG |> dplyr::filter(AdjP <= 0.01) |> dplyr::select(GeneID) |> unlist() |> as.character(), 'C:/Users/Erik/Desktop/Programming/R/Bio/Itch/p0_DEGs.csv', row.names = F, col.names = F, sep = ',')

p0_DRG_GO_BP_results <- read.table('C:/Users/Erik/Desktop/Programming/R/Bio/Itch/p0_DRG_GO_analysis_BP.txt', sep = '\t', skip = 11, header = T, quote = '')
p0_DRG_GO_CC_results <- read.table('C:/Users/Erik/Desktop/Programming/R/Bio/Itch/p0_DRG_GO_analysis_CC.txt', sep = '\t', skip = 11, header = T, quote = '')
p0_DRG_GO_MF_results <- read.table('C:/Users/Erik/Desktop/Programming/R/Bio/Itch/p0_DRG_GO_analysis_MF.txt', sep = '\t', skip = 11, header = T, quote = '')
p0_PANTHER_Pathways <- read.table('C:/Users/Erik/Desktop/Programming/R/Bio/Itch/p0_PANTHER_Pathways.txt', sep = '\t', skip = 11, header = T, quote = '')

p10_DRG <- read.csv("C:/Users/Erik/Downloads/DESeq2_result_file_on_GT_p10_mu123_wt1CE_PARA.csv", header = T)

write.table(p10_DRG |> dplyr::filter(AdjP <= 0.01) |> dplyr::select(GeneID) |> unlist() |> as.character(), 'C:/Users/Erik/Desktop/Programming/R/Bio/Itch/p10_DEGs.csv', row.names = F, col.names = F, sep = ',')

p10_DRG_GO_BP_results <- read.table('C:/Users/Erik/Desktop/Programming/R/Bio/Itch/p10_DRG_GO_analysis_BP.txt', sep = '\t', skip = 11, header = T, quote = '')
p10_DRG_GO_CC_results <- read.table('C:/Users/Erik/Desktop/Programming/R/Bio/Itch/p10_DRG_GO_analysis_CC.txt', sep = '\t', skip = 11, header = T, quote = '')
p10_DRG_GO_MF_results <- read.table('C:/Users/Erik/Desktop/Programming/R/Bio/Itch/p10_DRG_GO_analysis_MF.txt', sep = '\t', skip = 11, header = T, quote = '')
p10_PANTHER_Pathways <- read.table('C:/Users/Erik/Desktop/Programming/R/Bio/Itch/p10_PANTHER_Pathways.txt', sep = '\t', skip = 11, header = T, quote = '')
```
